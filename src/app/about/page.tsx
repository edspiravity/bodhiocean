    ...
    <div className="space-y-8">
      <header className="space-y-3">
        ...
        <p className="opacity-80">
          Bodhi Ocean is a quiet journal of practice — reflections, sutra notes,
          and observations from daily life as a lay practitioner.
        </p>
      </header>
      ...
      <article className="prose prose-neutral max-w-none">
        ...
        <ul>
          ...
          <li>
            Careful reading notes that walk through selected sutra passages in a plain, relatable, reflective, and practice-oriented way.
          </li>
